 ...
 */
#ifndef MLOGV
#define MLOGV(...) ((void)__android_log_buf_print(LOG_ID_MOBIS, ANDROID_LOG_VERBOSE, LOG_TAG, __VA_ARGS__))
#endif

#define CONDITION(cond)     (__builtin_expect((cond)!=0, 0))

#ifndef MLOGV_IF
#define MLOGV_IF(cond, ...) \
    ( (CONDITION(cond)) \
    ? ((void)__android_log_buf_print(LOG_ID_MOBIS, ANDROID_LOG_VERBOSE, LOG_TAG, __VA_ARGS__)) \
    : (void)0 )
#endif
//-NATIVE_PLATFORM
