...
struct {
    ...
    { "persist.ium.",     AID_SYSTEM,   0 },
    { "persist.sms.receive", AID_RADIO, 0 }, // 2018-05-25; 1623867@mobis.co.kr; Add SystemProperty to handle receiveing normal SMS
    { NULL, 0, 0 }
};
...
struct {
    ...
    { "dhcpcd_gobi", AID_RADIO, AID_RADIO },
    { "dhcpcd_gobi_1", AID_RADIO, AID_RADIO },	
     {NULL, 0, 0 }
};
