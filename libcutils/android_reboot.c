...
system("/system/bin/busybox echo remount_ro_done #1");
...
system("/system/bin/busybox echo remount_ro_done #2");

    do {
system("/system/bin/busybox echo remount_ro_done #2-1");
...
system("/system/bin/busybox echo remount_ro_done #3");
...
system("/system/bin/busybox echo remount_ro #1");
...
system("/system/bin/busybox echo remount_ro #2");
...
system("/system/bin/busybox echo remount_ro #3");
